...
public class ParamDTO {
   ...
   public ParamDTO(String id, String pass, String birth, String loc, String intro, String code, String name, String email,
		String ip, String secChUaPlatform, String userAgent, String profile, String[] language, Date inputDate) {
	super();
	this.id = id;
	this.pass = pass;
	this.birth = birth;
