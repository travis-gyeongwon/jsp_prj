  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
            <a href="<%= iDTO.getUrl() %>" target="_blank">
               <img src="http://192.169.10.69/jsp_prj/common/images/<%= iDTO.getImg() %>">
            </a>
            </div>
         ...
         <div class="row featurette">
         <div class="col-md">
         <img src = "http://192.168.10.95/jsp_prj/common/images/james.png">
         <br>
         허허허! 데이터 먼저 넣어 이 씹탱아
