  ...
  ================================================== -->
   ...
   <table id="joinFrm">
      <tr>
         ...
         <td class="input"><strong><c:out value="${ sessionScope.userId }"></c:out></strong>
         </td>
      </tr>
      ...
      <tr>
         ...
         <input type="button" value="업로드" id="btnUpload" class="btn btn-success btn-sm"/><br>
         <input type="hidden" name="profile" value="업로드" id="btnUpload" class="btn btn-success btn-sm"/><br>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td class="input">
         <input type="text" class="inputBox" name="mail" value="${ email }"/>@
      ...
      <tr>
         ...
         <td class="input"><input type="date" name="birth" class="inputBox" value="${ pDTO.birth }"/></td>
      </tr>
